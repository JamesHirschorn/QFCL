...
#message( STATUS "QuantLib_LIBRARY: " ${QuantLib_LIBRARY} )
string( REGEX REPLACE "(.*/)[a-zA-Z0-9]*\\..*" "\\1" library_path ${QuantLib_LIBRARY} ) 
#message( STATUS "lib path: " ${library_path} )
set ( QuantLib_LIBRARY_DIR ${library_path} CACHE FILEPATH "The QuantLib library directory" )
