...
file( GLOB distribution-boost-trunk ${source_dir}/random/distribution/boost-trunk/*.hpp )
file( GLOB ql ${source_dir}/random/generator/QuantLib/*.hpp )
file( GLOB generator ${source_dir}/random/generator/*.hpp )
...
file( GLOB miscellaneous ${source_dir}/miscellaneous/*.hpp )
...
source_group( qfcl\\random\\distribution\\boost-trunk FILES ${distribution-boost-trunk} )
source_group( qfcl\\random\\engine FILES ${engine} )
source_group( qfcl\\random\\generator\\QuantLib FILES ${ql} )
source_group( qfcl\\random\\generator FILES ${generator} )
...
source_group( qfcl\\miscellaneous FILES ${miscellaneous} )
