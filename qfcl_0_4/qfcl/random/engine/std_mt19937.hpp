...
typedef qfcl::tmp::concatenate<string::std_prefix, mt19937_name>::type std_mt19937_name;
}	// namespace detail
//! \endcond
...
typedef named_adaptor<std::mt19937, detail::std_mt19937_name> std_mt19937;
