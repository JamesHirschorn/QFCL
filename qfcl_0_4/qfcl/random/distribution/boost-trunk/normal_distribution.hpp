...
/*! \file qfcl/random/distribution/boost-trunk/normal_distribution.hpp
	...
	This is taken (essentially) verbatim from boost-trunk.
...
// Changed namespace from boost, because do not want to conflict with included boost library.
namespace boost_trunk {
namespace random {
